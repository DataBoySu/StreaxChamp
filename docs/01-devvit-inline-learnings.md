...
This document should be kept within the `docs/` directory as `01-devvit-inline-learnings.md` so future contributors can quickly follow a repeatable method to debug inline Devvit UI sizing problems.
